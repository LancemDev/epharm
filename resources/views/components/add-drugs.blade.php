    ...
    <div class="mt-4 bg-white dark:bg-gray-800 shadow-md rounded-lg text-left">
      ...
      <div class="px-8 py-6 ">
        <form action="{{ route('drugs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" placeholder="Category" name="category" class="border dark:bg-gray-800  w-full h-5 px-3 py-5 mt-2 hover:outline-none focus:outline-none focus:ring-indigo-500 focus:ring-1 rounded-md">
